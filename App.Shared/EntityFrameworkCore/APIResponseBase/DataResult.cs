...
namespace App.Shared.EntityFrameworkCore.APIResponseBase
{
    ...
    public class DataRattingResult : IDataResult
    {
        ...
        public static DataRattingResult ResultSucces(object data, string message, int totalReCords, RateDetail rateDetails) => new DataRattingResult()
        {
            Data = data,
            Message = message,
            Success = true,
